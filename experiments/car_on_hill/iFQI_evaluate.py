...
def run_cli(argvs=sys.argv[1:]):
    ...
    path_params = f"experiments/car_on_hill/figures/{args.experiment_name}/iFQI/{args.bellman_iterations_scope}_P_{args.seed}_0-{args.bellman_iterations_scope}"
    processes.append(
    ...
    for idx_forward_move in range(n_forward_moves):
        ...
        path_params = f"experiments/car_on_hill/figures/{args.experiment_name}/iFQI/{args.bellman_iterations_scope}_P_{args.seed}_{start_k}-{end_k}"
